...
namespace PayNow.Libraries.ComplyAdvantageClient.Models
{
    ...
    public partial class CaseManagement_CaseResultResponse : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Summary of alerts information, including the highest priority.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.CaseManagement_AlertsSummary? Alerts { get; set; }
#nullable restore
#else
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.CaseManagement_AlertsSummary Alerts { get; set; }
#endif
        /// <summary>User identifier that is currently assigned to case. null if un-assigned.</summary>
...
#nullable restore
        ...
        [Obsolete("")]
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.CaseManagement_CaseResultResponse_last_user_state? LastUserState { get; set; }
...
#nullable restore
        ...
        /// <summary>Subjects associated with the case, capped at the first 100.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public List<global::PayNow.Libraries.ComplyAdvantageClient.Models.CaseManagement_Subject> Subjects { get; set; }
#endif
        /// <summary>Summary information about the subjects associated with a case.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.CaseManagement_SubjectsSummary? SubjectsSummary { get; set; }
#nullable restore
#else
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.CaseManagement_SubjectsSummary SubjectsSummary { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::PayNow.Libraries.ComplyAdvantageClient.Models.CaseManagement_CaseResultResponse"/> and sets the default values.
        /// </summary>
        public CaseManagement_CaseResultResponse()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::PayNow.Libraries.ComplyAdvantageClient.Models.CaseManagement_CaseResultResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::PayNow.Libraries.ComplyAdvantageClient.Models.CaseManagement_CaseResultResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::PayNow.Libraries.ComplyAdvantageClient.Models.CaseManagement_CaseResultResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "alerts", n => { Alerts = n.GetObjectValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.CaseManagement_AlertsSummary>(global::PayNow.Libraries.ComplyAdvantageClient.Models.CaseManagement_AlertsSummary.CreateFromDiscriminatorValue); } },
                ...
                { "subjects_summary", n => { SubjectsSummary = n.GetObjectValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.CaseManagement_SubjectsSummary>(global::PayNow.Libraries.ComplyAdvantageClient.Models.CaseManagement_SubjectsSummary.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.CaseManagement_AlertsSummary>("alerts", Alerts);
            ...
            writer.WriteObjectValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.CaseManagement_SubjectsSummary>("subjects_summary", SubjectsSummary);
