...
namespace PayNow.Libraries.ComplyAdvantageClient.Models
{
    ...
    public partial class StructuredAddressV3 : global::PayNow.Libraries.ComplyAdvantageClient.Models.AddressV3, IParsable
    {
...
#nullable restore
        ...
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.AddressTypeV3? AddressType { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::PayNow.Libraries.ComplyAdvantageClient.Models.StructuredAddressV3"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::PayNow.Libraries.ComplyAdvantageClient.Models.StructuredAddressV3 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::PayNow.Libraries.ComplyAdvantageClient.Models.StructuredAddressV3();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "address_type", n => { AddressType = n.GetEnumValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.AddressTypeV3>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.AddressTypeV3>("address_type", AddressType);
