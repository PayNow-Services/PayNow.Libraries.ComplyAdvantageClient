...
namespace PayNow.Libraries.ComplyAdvantageClient.Models
{
    ...
    public partial class Search_TransactionV3 : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_CustomFieldV3>? CustomFields { get; set; }
#nullable restore
#else
        public List<global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_CustomFieldV3> CustomFields { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_MonetaryTransactionClassificationDetailsV3? Details { get; set; }
#nullable restore
#else
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_MonetaryTransactionClassificationDetailsV3 Details { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_EnrichmentV3>? Enrichments { get; private set; }
#nullable restore
#else
        public List<global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_EnrichmentV3> Enrichments { get; private set; }
#endif
        /// <summary>The combined outcome of all transaction evaluations.</summary>
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_TransactionV3_evaluation_outcome? EvaluationOutcome { get; private set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_LoanProductV3? Product { get; set; }
#nullable restore
#else
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_LoanProductV3 Product { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_RegulatoryReportDetailsV3? RegulatoryReportingDetails { get; set; }
#nullable restore
#else
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_RegulatoryReportDetailsV3 RegulatoryReportingDetails { get; set; }
#endif
        /// <summary>Represents the states of review decision</summary>
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_TransactionV3_review_decision? ReviewDecision { get; private set; }
        /// <summary>The version of the transaction.</summary>
        public int? Version { get; private set; }
        /// <summary>
        /// Instantiates a new <see cref="global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_TransactionV3"/> and sets the default values.
        /// </summary>
        public Search_TransactionV3()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_TransactionV3"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_TransactionV3 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_TransactionV3();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "custom_fields", n => { CustomFields = n.GetCollectionOfObjectValues<global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_CustomFieldV3>(global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_CustomFieldV3.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "details", n => { Details = n.GetObjectValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_MonetaryTransactionClassificationDetailsV3>(global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_MonetaryTransactionClassificationDetailsV3.CreateFromDiscriminatorValue); } },
                { "enrichments", n => { Enrichments = n.GetCollectionOfObjectValues<global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_EnrichmentV3>(global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_EnrichmentV3.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "product", n => { Product = n.GetObjectValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_LoanProductV3>(global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_LoanProductV3.CreateFromDiscriminatorValue); } },
                ...
                { "review_decision", n => { ReviewDecision = n.GetEnumValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_TransactionV3_review_decision>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.Search_LoanProductV3>("product", Product);
