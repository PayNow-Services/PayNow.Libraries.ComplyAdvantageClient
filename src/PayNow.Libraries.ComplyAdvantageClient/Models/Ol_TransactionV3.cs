...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_EnrichmentV3>? Enrichments { get; private set; }
#nullable restore
#else
        public List<global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_EnrichmentV3> Enrichments { get; private set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_TransactionV3.Ol_TransactionV3_initiating_channel? InitiatingChannel { get; set; }
#nullable restore
#else
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_TransactionV3.Ol_TransactionV3_initiating_channel InitiatingChannel { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_LoanProductV3? Product { get; set; }
#nullable restore
#else
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_LoanProductV3 Product { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "enrichments", n => { Enrichments = n.GetCollectionOfObjectValues<global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_EnrichmentV3>(global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_EnrichmentV3.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "initiating_channel", n => { InitiatingChannel = n.GetObjectValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_TransactionV3.Ol_TransactionV3_initiating_channel>(global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_TransactionV3.Ol_TransactionV3_initiating_channel.CreateFromDiscriminatorValue); } },
                { "occurred_at", n => { OccurredAt = n.GetDateTimeOffsetValue(); } },
                { "product", n => { Product = n.GetObjectValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_LoanProductV3>(global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_LoanProductV3.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_TransactionV3.Ol_TransactionV3_initiating_channel>("initiating_channel", InitiatingChannel);
            writer.WriteDateTimeOffsetValue("occurred_at", OccurredAt);
            writer.WriteObjectValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_LoanProductV3>("product", Product);
        ...
        /// <summary>
        /// Composed type wrapper for classes <see cref="global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_AtmChannelV3"/>, <see cref="global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_DeviceChannelV3"/>
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Ol_TransactionV3_initiating_channel : IComposedTypeWrapper, IParsable
        {
            /// <summary>Composed type representation for type <see cref="global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_AtmChannelV3"/></summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_AtmChannelV3? OlAtmChannelV3 { get; set; }
#nullable restore
#else
            public global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_AtmChannelV3 OlAtmChannelV3 { get; set; }
#endif
            /// <summary>Composed type representation for type <see cref="global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_DeviceChannelV3"/></summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_DeviceChannelV3? OlDeviceChannelV3 { get; set; }
#nullable restore
#else
            public global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_DeviceChannelV3 OlDeviceChannelV3 { get; set; }
#endif
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_TransactionV3.Ol_TransactionV3_initiating_channel"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_TransactionV3.Ol_TransactionV3_initiating_channel CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var mappingValue = parseNode.GetChildNode("type")?.GetStringValue();
                var result = new global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_TransactionV3.Ol_TransactionV3_initiating_channel();
                if("ol_AtmChannelV3".Equals(mappingValue, StringComparison.OrdinalIgnoreCase))
                {
                    result.OlAtmChannelV3 = new global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_AtmChannelV3();
                }
                else if("ol_DeviceChannelV3".Equals(mappingValue, StringComparison.OrdinalIgnoreCase))
                {
                    result.OlDeviceChannelV3 = new global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_DeviceChannelV3();
                }
                return result;
            }
            /// <summary>
            ...
            public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
            {
                if(OlAtmChannelV3 != null)
                {
                    return OlAtmChannelV3.GetFieldDeserializers();
                }
                else if(OlDeviceChannelV3 != null)
                {
                    return OlDeviceChannelV3.GetFieldDeserializers();
                }
                return new Dictionary<string, Action<IParseNode>>();
            }
            /// <summary>
            ...
            public virtual void Serialize(ISerializationWriter writer)
            {
                ...
                if(OlAtmChannelV3 != null)
                {
                    writer.WriteObjectValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_AtmChannelV3>(null, OlAtmChannelV3);
                }
                else if(OlDeviceChannelV3 != null)
                {
                    writer.WriteObjectValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.Ol_DeviceChannelV3>(null, OlDeviceChannelV3);
                }
            }
        }
    }
