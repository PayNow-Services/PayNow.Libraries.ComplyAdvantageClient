...
namespace PayNow.Libraries.ComplyAdvantageClient.Models
{
    ...
    public partial class Activity_TransactionV3 : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_CustomFieldV3>? CustomFields { get; set; }
#nullable restore
#else
        public List<global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_CustomFieldV3> CustomFields { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_TransactionV3.Activity_TransactionV3_initiating_channel? InitiatingChannel { get; set; }
#nullable restore
#else
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_TransactionV3.Activity_TransactionV3_initiating_channel InitiatingChannel { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_RegulatoryReportDetailsV3? RegulatoryReportingDetails { get; set; }
#nullable restore
#else
        public global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_RegulatoryReportDetailsV3 RegulatoryReportingDetails { get; set; }
#endif
        ...
        public static global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_TransactionV3 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_TransactionV3();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "custom_fields", n => { CustomFields = n.GetCollectionOfObjectValues<global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_CustomFieldV3>(global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_CustomFieldV3.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_CustomFieldV3>("custom_fields", CustomFields);
            writer.WriteObjectValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_MonetaryTransactionClassificationDetailsV3>("details", Details);
        ...
        /// <summary>
        /// Composed type wrapper for classes <see cref="global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_AtmChannelV3"/>, <see cref="global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_DeviceChannelV3"/>
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Activity_TransactionV3_initiating_channel : IComposedTypeWrapper, IParsable
        {
            /// <summary>Composed type representation for type <see cref="global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_AtmChannelV3"/></summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_AtmChannelV3? ActivityAtmChannelV3 { get; set; }
#nullable restore
#else
            public global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_AtmChannelV3 ActivityAtmChannelV3 { get; set; }
#endif
            /// <summary>Composed type representation for type <see cref="global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_DeviceChannelV3"/></summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_DeviceChannelV3? ActivityDeviceChannelV3 { get; set; }
#nullable restore
#else
            public global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_DeviceChannelV3 ActivityDeviceChannelV3 { get; set; }
#endif
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_TransactionV3.Activity_TransactionV3_initiating_channel"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_TransactionV3.Activity_TransactionV3_initiating_channel CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            ...
            public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
            {
                if(ActivityAtmChannelV3 != null)
                {
                    return ActivityAtmChannelV3.GetFieldDeserializers();
                }
                else if(ActivityDeviceChannelV3 != null)
                {
                    return ActivityDeviceChannelV3.GetFieldDeserializers();
                }
                return new Dictionary<string, Action<IParseNode>>();
            }
            /// <summary>
            ...
            public virtual void Serialize(ISerializationWriter writer)
            {
                ...
                if(ActivityAtmChannelV3 != null)
                {
                    writer.WriteObjectValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_AtmChannelV3>(null, ActivityAtmChannelV3);
                }
                else if(ActivityDeviceChannelV3 != null)
                {
                    writer.WriteObjectValue<global::PayNow.Libraries.ComplyAdvantageClient.Models.Activity_DeviceChannelV3>(null, ActivityDeviceChannelV3);
                }
            }
        }
    }
