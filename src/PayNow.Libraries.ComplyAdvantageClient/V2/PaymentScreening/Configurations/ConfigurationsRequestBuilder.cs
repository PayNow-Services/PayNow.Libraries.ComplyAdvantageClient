...
namespace PayNow.Libraries.ComplyAdvantageClient.V2.PaymentScreening.Configurations
{
    ...
    public partial class ConfigurationsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// This endpoint returns a list of all payment screening configurations with their metadataPayment screening configurations define which lists a transaction will be screened against and the fuzziness that should be applied to the search. You can create multiple configurations in your account. Each payment screening configuration can have multiple versions.        You need the &quot;Access to base payment screening functionality&quot; permission to use this endpoint.
        /// </summary>
