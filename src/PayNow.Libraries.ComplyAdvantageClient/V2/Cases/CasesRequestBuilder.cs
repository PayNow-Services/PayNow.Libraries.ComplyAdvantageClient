...
namespace PayNow.Libraries.ComplyAdvantageClient.V2.Cases
{
    ...
    public partial class CasesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Returns a paginated list of cases for the user&apos;s account. Accepts filter and sort query parameters.You need one of the &quot;View cases (customer onboarding)&quot;, &quot;View cases (customer monitoring)&quot;, &quot;View cases (payment screening)&quot; or &quot;View cases (transaction monitoring)&quot; permissions to use this endpoint.
        /// </summary>
