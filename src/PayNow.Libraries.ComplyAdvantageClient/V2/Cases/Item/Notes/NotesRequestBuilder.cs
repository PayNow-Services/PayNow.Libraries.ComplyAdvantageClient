...
namespace PayNow.Libraries.ComplyAdvantageClient.V2.Cases.Item.Notes
{
    ...
    public partial class NotesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Returns a paginated list of notes associated with a case.You need one of the &quot;View cases (customer onboarding)&quot;, &quot;View cases (customer monitoring)&quot;, &quot;View cases (payment screening)&quot; or &quot;View cases (transaction monitoring)&quot; permissions to use this endpoint.
        /// </summary>
